...
class TestMemberships:
    ...
    def test_method_list(self, client: Outline) -> None:
        membership = client.collections.memberships.list(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(MembershipListResponse, membership, path=["response"])
    ...
    def test_raw_response_list(self, client: Outline) -> None:
        response = client.collections.memberships.with_raw_response.list(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_list(self, client: Outline) -> None:
        with client.collections.memberships.with_streaming_response.list(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
...
class TestAsyncMemberships:
    ...
    async def test_method_list(self, async_client: AsyncOutline) -> None:
        membership = await async_client.collections.memberships.list(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(MembershipListResponse, membership, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncOutline) -> None:
        response = await async_client.collections.memberships.with_raw_response.list(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncOutline) -> None:
        async with async_client.collections.memberships.with_streaming_response.list(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
