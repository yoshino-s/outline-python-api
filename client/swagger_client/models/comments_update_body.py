...
class CommentsUpdateBody(object):
    ...
    def __init__(self, id=None, data=None):  # noqa: E501
        """CommentsUpdateBody - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._data = None
    ...
    @property
    def id(self):
        """Gets the id of this CommentsUpdateBody.  # noqa: E501


        :return: The id of this CommentsUpdateBody.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CommentsUpdateBody.


        :param id: The id of this CommentsUpdateBody.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def data(self):
        """Gets the data of this CommentsUpdateBody.  # noqa: E501


        :return: The data of this CommentsUpdateBody.  # noqa: E501
        :rtype: object
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this CommentsUpdateBody.


        :param data: The data of this CommentsUpdateBody.  # noqa: E501
        :type: object
        """
        if data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CommentsUpdateBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CommentsUpdateBody):
            return False
