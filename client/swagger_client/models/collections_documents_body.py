...
class CollectionsDocumentsBody(object):
    ...
    def __init__(self, id=None):  # noqa: E501
        """CollectionsDocumentsBody - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this CollectionsDocumentsBody.  # noqa: E501

        Unique identifier for the collection.  # noqa: E501

        :return: The id of this CollectionsDocumentsBody.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CollectionsDocumentsBody.

        Unique identifier for the collection.  # noqa: E501

        :param id: The id of this CollectionsDocumentsBody.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CollectionsDocumentsBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CollectionsDocumentsBody):
            return False
