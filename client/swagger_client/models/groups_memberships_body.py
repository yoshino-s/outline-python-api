...
class GroupsMembershipsBody(Pagination):
    ...
    def __init__(self, id=None, query=None, *args, **kwargs):  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this GroupsMembershipsBody.  # noqa: E501

        Group id  # noqa: E501

        :return: The id of this GroupsMembershipsBody.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this GroupsMembershipsBody.

        Group id  # noqa: E501

        :param id: The id of this GroupsMembershipsBody.  # noqa: E501
        :type: str
        """
        if id is None:
