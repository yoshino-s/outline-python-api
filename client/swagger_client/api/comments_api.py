...
class CommentsApi(object):
    ...
    def comments_create_post(self, **kwargs):  # noqa: E501
        """Create a comment  # noqa: E501

        Create a comment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.comments_create_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CommentsCreateBody body:
        ...
        if kwargs.get('async_req'):
            return self.comments_create_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.comments_create_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def comments_create_post_with_http_info(self, **kwargs):  # noqa: E501
        """Create a comment  # noqa: E501

        Create a comment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.comments_create_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method comments_create_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def comments_delete_post(self, **kwargs):  # noqa: E501
        """Delete a comment  # noqa: E501

        Delete a comment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.comments_delete_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CommentsDeleteBody body:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.comments_delete_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.comments_delete_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def comments_delete_post_with_http_info(self, **kwargs):  # noqa: E501
        """Delete a comment  # noqa: E501

        Delete a comment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.comments_delete_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method comments_delete_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def comments_list_post(self, **kwargs):  # noqa: E501
        """List all comments  # noqa: E501

        This method will list all comments matching the given properties.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.comments_list_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CommentsListBody body:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.comments_list_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.comments_list_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def comments_list_post_with_http_info(self, **kwargs):  # noqa: E501
        """List all comments  # noqa: E501

        This method will list all comments matching the given properties.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.comments_list_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method comments_list_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def comments_update_post(self, **kwargs):  # noqa: E501
        """Update a comment  # noqa: E501

        Update a comment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.comments_update_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CommentsUpdateBody body:
        :return: InlineResponse20013
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.comments_update_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.comments_update_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def comments_update_post_with_http_info(self, **kwargs):  # noqa: E501
        """Update a comment  # noqa: E501

        Update a comment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.comments_update_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method comments_update_post" % key
                )
            params[key] = val
        del params['kwargs']
