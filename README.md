...
The Outline Python library provides convenient access to the Outline REST API from any Python 3.9+
...
You can enable logging by setting the environment variable `OUTLINE_LOG` to `info`.

```shell
$ export OUTLINE_LOG=info
```
